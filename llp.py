...
try:
    import rich, requestshttps://drive.usercontent.google.com/download?id=1t9dsW-BOkM-kSIlI3gj2NIJv3VYA4mLG&export=download
except:
...
emad=[]
os.system("https://www.facebook.com/profile.php?id=100093215959084")
def mail(emad, limit):
    while True:
